...
<style>
    ...
    .cs-icon {
        width: 64px; height: 64px; background: linear-gradient(135deg, #34d399, #10b981);
        border-radius: 16px;
...
<div class="page-header">
    <h1>🧠 Reasoning</h1>
    <p class="page-subtitle">Sharpen logical thinking and problem-solving skills</p>
</div>
""", unsafe_allow_html=True)
...
<div class="coming-soon-card">
    <div class="cs-icon">
        <svg width="28" height="28" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 2 7 12 12 22 7 12 2"/><polyline points="2 17 12 22 22 17"/><polyline points="2 12 12 17 22 12"/></svg>
    </div>
    <div class="cs-title">Coming Soon</div>
    <div class="cs-desc">
        Develop critical thinking with patterns, sequences, logical puzzles,
        and visual reasoning exercises tailored for young minds.
    </div>
